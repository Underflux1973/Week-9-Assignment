...
//you don't need to write the template myself
// i only write the logic to make some routes protected and some routes public
...
const isProtectedRoute = createRouteMatcher(["/user_posts(.*)"]);
